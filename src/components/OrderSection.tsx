  ...
  return (
    ...
    >
      <div className="container-custom">
        ...
        {/* Unified Ordered Checkout Form Container */}
        <div className="max-w-3xl mx-auto">
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            
            {/* 1. TOP: Delivery Info Form Card */}
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-sm space-y-5">
              <div className="flex items-center justify-between pb-3 border-b border-slate-100">
                <h3 className="text-base sm:text-lg font-bold text-slate-900 flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-[#0265FF] text-white text-xs flex items-center justify-center font-bold font-number shadow-xs">
                    ১
                  </span>
                  <span>আপনার ডেলিভারি তথ্য দিন</span>
                </h3>
                <span className="text-xs font-semibold px-2.5 py-1 rounded-xl bg-slate-50 border border-slate-200 text-slate-600 hidden sm:inline-block">
                  ক্যাশ অন ডেলিভারি
                </span>
              </div>
            ...
            {/* 2. MIDDLE: Color Selection & Quantity Card */}
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-sm space-y-5">
              <div className="flex items-center justify-between pb-3 border-b border-slate-100">
                <h3 className="text-base sm:text-lg font-bold text-slate-900 flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-[#0265FF] text-white text-xs flex items-center justify-center font-bold font-number shadow-xs">
                  ...
                  <span>রঙ ও পরিমাণ নির্বাচন করুন</span>
                </h3>
                <span className="text-xs font-semibold px-2.5 py-1 rounded-xl bg-blue-50 border border-blue-200/60 text-[#0265FF]">
                  নির্বাচিত রঙ: {currentColor.name}
                </span>
              </div>
                ...
                {COLOR_VARIANTS.map((variant) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative flex flex-col items-center p-3.5 sm:p-4 rounded-2xl border-2 transition-all duration-200 cursor-pointer bg-white text-center ${
                        isSelected
                          ? "border-[#0265FF] ring-3 ring-blue-500/10 shadow-md scale-[1.01]"
                          : "border-slate-200/80 hover:border-slate-300"
                      }`}
                    >
                      <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-xl overflow-hidden mb-2.5 bg-slate-50 p-1 flex items-center justify-center">
                        <img
                          src={variant.image}
                          alt={variant.name}
            ...
            {/* 3. LOWER MIDDLE: Delivery Area Selector & Price Summary Card */}
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-sm space-y-5">
              <div className="flex items-center justify-between pb-3 border-b border-slate-100">
                <h3 className="text-base sm:text-lg font-bold text-slate-900 flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-[#0265FF] text-white text-xs flex items-center justify-center font-bold font-number shadow-xs">
                  ...
                  <span>ডেলিভারি এলাকা ও হিসাব</span>
                </h3>
              ...
              <div className="pt-4 border-t border-slate-100 space-y-2.5 text-sm bg-slate-50/70 p-4 rounded-2xl border border-slate-100">
                ...
                <div className="pt-2.5 border-t border-slate-200 flex justify-between items-center text-base sm:text-lg font-bold text-slate-900">
            ...
            {/* 4. BOTTOM: Order Confirm Submit CTA Button */}
            <div className="space-y-3 pt-2">
              <button
                type="submit"
                disabled={isSubmitting}
                className="w-full bg-[#0265FF] hover:bg-[#0052CC] disabled:opacity-75 text-white text-base sm:text-lg font-bold py-4 sm:py-4.5 px-6 rounded-2xl transition-all duration-200 shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30 active:scale-98 flex items-center justify-center gap-2.5 cursor-pointer"
              >
                {isSubmitting ? (
                  <>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-2 text-xs text-slate-500 text-center pt-1">
